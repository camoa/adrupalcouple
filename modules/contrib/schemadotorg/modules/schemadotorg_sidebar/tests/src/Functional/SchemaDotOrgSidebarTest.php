...
class SchemaDotOrgSidebarTest extends SchemaDotOrgBrowserTestBase {
  ...
  public function testSidebar(): void {
    ...
    $assert_session->responseContains('Sidebar test');
    ...
    $sidebar_paragraph = $node->field_sidebar_test->entity;
    $sidebar_paragraph->field_sidebar_text->value = '';
    ...
    $this->drupalGet("/node/$nid");
    $assert_session->responseNotContains('Sidebar test');
