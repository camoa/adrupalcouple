...
class SchemaDotOrgExportTest extends SchemaDotOrgBrowserTestBase {
  ...
  public function testDescriptions(): void {
    ...
    $assert_session->linkByHrefExists('/admin/config/schemadotorg/mappings/export');
    ...
    $assert_session->linkByHrefExists('/admin/config/schemadotorg/sets/export');
    $assert_session->responseContains('<u>⇩</u> Download CSV');
    ...
    $assert_session->linkByHrefExists('/admin/reports/schemadotorg/Article/export');
    $assert_session->responseContains('<u>⇩</u> Download CSV');

    // Check Schema.org type CSV export.
    $this->drupalGet('/admin/reports/schemadotorg/Article/export');
    $assert_session->responseContains('id,label,comment,sub_property_of,equivalent_property,subproperties,domain_includes,range_includes,inverse_of,supersedes,superseded_by,is_part_of,drupal_name,drupal_label,drupal_description,status');
