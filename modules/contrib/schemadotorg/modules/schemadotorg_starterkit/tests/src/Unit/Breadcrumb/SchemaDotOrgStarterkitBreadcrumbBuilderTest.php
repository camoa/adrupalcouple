...
namespace Drupal\Tests\schemadotorg_starterkit\Unit\Breadcrumb;
...
/**
 * @coversDefaultClass \Drupal\schemadotorg_starterkit\Breadcrumb\SchemaDotOrgStarterkitBreadcrumbBuilder
 * @group schemadotorg
 */
class SchemaDotOrgStarterkitBreadcrumbBuilderTest extends UnitTestCase {
  ...
  /**
   * Tests SchemaDotOrgStarterkitBreadcrumbBuilder::applies().
   *
   * @param bool $expected
   *   SchemaDotOrgStarterkitBreadcrumbBuilder::applies() expected result.
  ...
  public function testApplies(bool $expected, ?string $route_name = NULL): void {
    $breadcrumb_builder = $this->createPartialMock('\Drupal\schemadotorg_starterkit\Breadcrumb\SchemaDotOrgStarterkitBreadcrumbBuilder', []);
   ...
   *   - SchemaDotOrgStarterkitBreadcrumbBuilder::applies() expected result.
   *   - SchemaDotOrgStarterkitBreadcrumbBuilder::applies() route name.
   */
  public function providerTestApplies(): array {
    return [
      [FALSE],
      [FALSE, 'schemadotorg_starterkit'],
      [TRUE, 'schemadotorg_starterkit.page'],
      [TRUE, 'schemadotorg_starterkit.confirm_form'],
    ];
  }
  ...
  public function testBuild(): void {
    ...
    $route_match->method('getRouteName')
      ->willReturn('schemadotorg_starterkit.confirm_form');
    $breadcrumb = $breadcrumb_builder->build($route_match);
    ...
    $expected = [
      ...
      Link::createFromRoute('Configuration', 'system.admin_config'),
      Link::createFromRoute('Schema.org', 'schemadotorg'),
      Link::createFromRoute('Starter kits', 'schemadotorg_starterkit.overview'),
    ];
    $this->assertEquals($expected, $breadcrumb->getLinks());
  }
