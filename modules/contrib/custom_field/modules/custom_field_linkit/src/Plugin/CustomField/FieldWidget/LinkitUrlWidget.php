 ...
 * )
 */
class LinkitUrlWidget extends CustomFieldWidgetBase implements ContainerFactoryPluginInterface, CustomFieldWidgetInterface {
  ...
  public function widget(FieldItemListInterface $items, int $delta, array $element, array &$form, FormStateInterface $form_state, CustomFieldTypeInterface $field): array {
    ...
    if ($entity instanceof FileInterface) {
      ...
      $element['#default_value'] = \Drupal::service('file_url_generator')->generateString($entity->getFileUri());
    }
