...
```bash
php core/scripts/drupal generate-theme my_daisyui_theme --starterkit adrupalcouple --path themes/custom
```
...
### DaisyUI themes
DaisyUI themes are placed under css/themes/theme.pcss.css and must included in `adrupalcouple.libraries.yml`.
